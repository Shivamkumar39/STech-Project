...
const services = [
  { 
    ...
    img: 'https://cdn-icons-png.flaticon.com/512/1055/1055687.png' // updated modern web dev icon
  },
  { 
    title: 'Logo Design', 
  ...
  <section id="services" className="py-16 bg-[#0a192f] text-white text-center">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-7xl mx-auto px-6">
      {services.map(({ title, desc, img }, index) => (
        <Tilt
          key={index}
          className="bg-[#112240] p-8 rounded-2xl shadow-xl hover:shadow-2xl border border-blue-800 hover:border-teal-400 transform transition duration-300"
          tiltMaxAngleX={10}
          tiltMaxAngleY={10}
          glareEnable={true}
